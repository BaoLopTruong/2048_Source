...
cc.Class({
    ...
    compareCards(selfCard, otherCard) {
        ...
        //     return;
        // }else{
      // valueSelf = selfCard.node.getComponent("card").value.string;
        //valueOther = otherCard.node.getComponent("card").value.string;
        
       // cc.log(selfCard)

        // if (valueOther == valueSelf) {
        //  totalValue = valueOther + valueSelf;
        //selfCard.node.getComponent('card').value.string = totalValue;
        //otherCard fadeOUT
        //this.addColor(selfCard, totalValue);
        //     //   return true;
        // }
        // else {
        //     return false;
